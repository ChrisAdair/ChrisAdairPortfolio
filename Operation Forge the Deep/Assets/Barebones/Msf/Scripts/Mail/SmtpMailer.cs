...
namespace Barebones.MasterServer
{
    public class SmtpMailer : Mailer
    {
        ...
        public string SmtpUsername = "chriswadair@gmail.com";
        public string SmtpPassword = "greatfam09";
        public string EmailFrom = "GrainGame@gmail.com";
        public string SenderDisplayName = "Operation Forge the Deep";
