...
namespace Barebones.MasterServer
{
    public class MsfServer : MsfBaseClient
    {
        ...
        public SaveLoadServer Save { get; private set; }
        public LeaderboardServer Leader { get; private set; }
        ...
        public MsfServer(IClientSocket connection) : base(connection)
        {
            ...
            Save = new SaveLoadServer(connection);
            Leader = new LeaderboardServer(connection);
        }
    }
}